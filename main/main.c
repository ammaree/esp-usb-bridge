...
{
    led_io_set(LED_ID_RX, active);
}

static void serial_rx_activity_callback(bool active)
{
    led_io_set(LED_ID_TX, active);
}

void app_main(void)
{
    led_io_init(); // Keep this at the beginning. LEDs are used for error reporting.
